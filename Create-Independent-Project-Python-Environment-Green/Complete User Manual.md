...
**Portable / green edition:** double-click `Create Independent Project Python Environment.exe` in this folder. No `.lnk` shortcut and no extra `.bat` for the end user.
